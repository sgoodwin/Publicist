...
public class RSAppMovementMonitor: NSObject {
	...
	override public init() {
		let appName = Bundle.main.infoDictionary?[kCFBundleNameKey as String] as? String ?? NSLocalizedString("Publisher", comment: "Backup name if the app name cannot be deduced from the bundle")
